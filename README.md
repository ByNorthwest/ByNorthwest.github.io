...
A personal blog built with Astro.js and Tailwind CSS. Featuring a minimal, responsive and content-focused design.
...
1. Update `src/data/site-config.ts` with your personal information
2. Add your blog posts to `src/content/blog/`
3. Update the pages in `src/content/pages/` (about, contact, terms)
4. Replace the placeholder images in `src/assets/images/`
